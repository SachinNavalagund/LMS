...
const StripeProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [createStripPaymentIntent] = useCreateStripePaymentIntentMutation();
  ...
  useEffect(() => {
    ...
    const fetchPaymentIntent = async () => {
      const result = await createStripPaymentIntent({
    ...
    fetchPaymentIntent();
  }, [createStripPaymentIntent, course?.price, course]);
